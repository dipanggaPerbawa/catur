...
public class QueenL extends pieceLearn {

    public QueenL(int x, int y, boolean is_white, String file_path, boardLearn board) {
    ...
    public boolean canMove(int destination_x, int destination_y)
    {
        ...
        if (destination_x < this.getX()){
            ...
            if (direction.equals("bawah kiri")){
                ...
                {
                    pieceLearn p = board.getPiece(this.getX() - i, this.getY() + i);
                    if (p != null){
                        return false;
                    }
            ...
            if (direction.equals("selatan")){
                ...
                for (int i = 1; i < spaces_to_move; i++)
                {
                    pieceLearn p = board.getPiece(this.getX(), this.getY() + i);
                    if (p != null){
                        return false;
                    }
                }
            ...
            if (direction.equals("timur")){
               ...
               for (int i = 1; i < spaces_to_move; i++)
               {
                pieceLearn p = board.getPiece(this.getX() + 1, this.getY());
                   if (p != null){
                       return false;
                   }
               }
